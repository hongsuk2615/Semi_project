...
/**
 * Servlet implementation class GetFilteredReportedBoardAjaxController
 */
@WebServlet("/filteredReportedBoard.get")
public class GetFilteredReportedBoardAjaxController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public GetFilteredReportedBoardAjaxController() {
        super();
