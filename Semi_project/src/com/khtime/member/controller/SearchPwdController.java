...
public class SearchPwdController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		request.getRequestDispatcher("views/member/searchPwdForm.jsp").forward(request, response);
	}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		boolean result = new MemberService().searchPwd(userId, userEmail);
	
		request.setAttribute("emailCheck", result);
		request.getRequestDispatcher("views/member/searchPwdViewForm.jsp").forward(request, response);
