 ...
 */
@WebServlet("/myScrap.bo")
public class UserScrapController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public UserScrapController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		listCount = new BoardService().listCountScrap(userNo);
		currentPage = Integer
		...
		ArrayList<Board> boardList = new BoardService().userScrap(pi, userNo);
